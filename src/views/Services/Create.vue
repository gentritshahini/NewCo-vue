<template>
  <div class="container mx-auto py-3">
    <div class="mb-3">
      <h1 class="text-2xl font-bold text-left uppercase">Create Service</h1>
    </div>
...
export default {
  ...
  methods: {
    checkForm(e) {
      ...
      if (!this.form.price) this.errors.push("Price is required.");

      if (isNaN(this.form.active)) this.errors.push("Status is required.");

      if (this.errors == "") {
        axios
          .post("http://localhost/newco/api/services/create.php", {
