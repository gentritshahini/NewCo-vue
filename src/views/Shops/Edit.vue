<template>
  <div class="container mx-auto py-3">
    <div class="mb-3">
      <h1 class="text-2xl font-bold text-left uppercase">Update Shop</h1>
    </div>
...
export default {
  ...
  methods: {
    checkForm(e) {
      ...
      if (!this.form.location_id) this.errors.push("City is required.");

      if (this.errors == "") {
        axios
          .put("http://localhost/newco/api/shops/update.php", {
            id: this.form.id,
            name: this.form.name,
          ...
          .then(
            () => {
              this.$router.push("/shops/" + this.form.id + "/show");
            },
            (error) => {
