  ...
  <div class="container mx-auto py-3">
    <div class="bg-white shadow sm:rounded-lg mb-4">
        <div class="px-4 py-5 sm:px-6 flex justify-between">
            ...
            <div>
                <router-link to="/customers" class="text-white hover:opacity-75 bg-green-300 py-2 px-3 rounded-lg mr-2 text-sm leading-4">
                    All customers
                </router-link>
                ...
                <button @click="deleteCustomer" class="text-white hover:opacity-75 bg-red-600 py-2 px-3 rounded-lg text-sm leading-4 focus:outline-none">
                    Delete
                </button>
            </div>
        </div>
